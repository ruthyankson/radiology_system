...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('general_setup', '0002_department_created_by_educationallevel_created_by_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pregnant', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=50, null=True)),
